...
from servier.nn_utils import param_count
from servier.parsing import add_train_args, modify_train_args
from servier.train import cross_validate


DATASETS = OrderedDict()
DATASETS['freesolv'] = ('regression', '/data/rsg/chemistry/yangk/servier/data/freesolv.csv', 10, 'rmse')
DATASETS['delaney'] = ('regression', '/data/rsg/chemistry/yangk/servier/data/delaney.csv', 10, 'rmse')
DATASETS['lipo'] = ('regression', '/data/rsg/chemistry/yangk/servier/data/lipo.csv', 10, 'rmse')
DATASETS['pdbbind_full'] = ('regression', '/data/rsg/chemistry/yangk/servier/data/pdbbind_full.csv', 10, 'rmse')
DATASETS['pdbbind_core'] = ('regression', '/data/rsg/chemistry/yangk/servier/data/pdbbind_core.csv', 10, 'rmse')
DATASETS['pdbbind_refined'] = ('regression', '/data/rsg/chemistry/yangk/servier/data/pdbbind_refined.csv', 10, 'rmse')
DATASETS['qm7'] = ('regression', '/data/rsg/chemistry/yangk/servier/data/qm7.csv', 10, 'mae')
DATASETS['qm8'] = ('regression', '/data/rsg/chemistry/yangk/servier/data/qm8.csv', 10, 'mae')
DATASETS['qm9'] = ('regression', '/data/rsg/chemistry/yangk/servier/data/qm9.csv', 3, 'mae')
DATASETS['pcba'] = ('classification', '/data/rsg/chemistry/yangk/servier/data/pcba.csv', 3, 'prc-auc')
DATASETS['muv'] = ('classification', '/data/rsg/chemistry/yangk/servier/data/muv.csv', 3, 'prc-auc')
DATASETS['hiv'] = ('classification', '/data/rsg/chemistry/yangk/servier/data/HIV.csv', 3, 'auc')
DATASETS['bace'] = ('classification', '/data/rsg/chemistry/yangk/servier/data/bace.csv', 10, 'auc')
DATASETS['bbbp'] = ('classification', '/data/rsg/chemistry/yangk/servier/data/BBBP.csv', 10, 'auc')
DATASETS['tox21'] = ('classification', '/data/rsg/chemistry/yangk/servier/data/tox21.csv', 10, 'auc')
DATASETS['toxcast'] = ('classification', '/data/rsg/chemistry/yangk/servier/data/toxcast.csv', 10, 'auc')
DATASETS['sider'] = ('classification', '/data/rsg/chemistry/yangk/servier/data/sider.csv', 10, 'auc')
DATASETS['clintox'] = ('classification', '/data/rsg/chemistry/yangk/servier/data/clintox.csv', 10, 'auc')
...
if __name__ == '__main__':
    ...
    if 'all' in args.experiments or 'atom_messages' in args.experiments:
        ...
        from servier.features.featurization import clear_cache  # needed b/c cache is different for atom messages
        clear_cache()
        run_comparison(experiment_args, logger)
        clear_cache()
