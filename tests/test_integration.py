...
from servier.constants import TEST_SCORES_FILE_NAME
from servier.hyperparameter_optimization import servier_hyperopt
from servier.interpret import servier_interpret
from servier.sklearn_predict import sklearn_predict
from servier.sklearn_train import sklearn_train
from servier.train import servier_train, servier_predict, evaluate_predictions, servier_fingerprint
from servier.web.wsgi import build_app
from servier.spectra_utils import normalize_spectra, load_phase_mask
from servier.features import load_features
...
class ServierTests(TestCase):
    @staticmethod
    def create_raw_train_args(dataset_type: str,
                              metric: str,
                              save_dir: str,
                              model_type: str = 'servier',
        ...
        return [
            ...
            '--quiet',
            '--empty_cache'
        ] + (['--model_type', model_type] if model_type != 'servier' else []) + (flags if flags is not None else [])
    ...
    @parameterized.expand([
        ...
        (
                'servier_morgan_features_generator',
                'servier',
                'rmse',
                2.0438637,
    ...
    def test_servier_hyperopt(self):
        with TemporaryDirectory() as save_dir:
            # Train
    ...
    @parameterized.expand([(
        ...
        (
                'servier_reaction_solvent_explicit_h',
                'servier',
                3.01241762,
                ['--reaction_solvent', '--number_of_molecules', '2',
        ...
        (
                'servier_reaction_solvent_explicit_h_adding_h',
                'servier',
                2.984292677,
                ['--reaction_solvent', '--number_of_molecules', '2',
        ...
        (
                'servier_reaction_solvent_diff_mpn_size',
                'servier',
                2.730379557,
                ['--reaction_solvent', '--number_of_molecules', '2',
