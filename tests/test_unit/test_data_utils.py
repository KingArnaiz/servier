"""servier unit tests for servier/data/utils.py"""
import os
...
from servier.data import get_header, preprocess_smiles_columns, get_task_names, get_data_weights, \
...
@patch(
    "servier.data.utils.preprocess_smiles_columns",
...
@patch(
    "servier.data.utils.get_data_weights",
...
class TestGetData(TestCase):
    ...
    @patch(
        "servier.data.utils.load_features",
